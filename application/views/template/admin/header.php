...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link <?= $dashboard ?>" href="<?= base_url('admin') ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $packet ?>" href="<?= base_url('paket') ?>">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $pelanggan ?>" href="<?= base_url('admin/pelanggan') ?>">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $transaksi ?>" href="<?= base_url('admin/transaksi') ?>">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="/">cuciKu</a></li>
                        ...
                        <ul class="navbar-nav justify-content-end">
                            ...
                            <li class="nav-item dropdown px-3 pe-2 d-flex align-items-center">
                                ...
                                <ul class="dropdown-menu  dropdown-menu-end px-2" aria-labelledby="usermenu">
                                    <li>
                                        <a class="dropdown-item border-radius-md" href="<?= base_url('admin/profil') ?>">
